...
class CalcListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by CalcParser#st.
    def enterSt(self, ctx:CalcParser.StContext):
        pass

    # Exit a parse tree produced by CalcParser#st.
    def exitSt(self, ctx:CalcParser.StContext):
        pass
